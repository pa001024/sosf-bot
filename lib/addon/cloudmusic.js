...
function biMultiplyDigit(a, b) {
	var c, d, e, f, result = new BigInt();
	for (c = biHighIndex(a), d = 0, f = 0; c >= f; ++f) e = result.digits[f] + a.digits[f] * b + d, result.digits[f] = e & maxDigitVal, d = e >>> biRadixBits;
...
function genRandom(a) {
	var i, e, b = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789",
		rst = "";
	for (i = 0; a > i; i += 1)
		e = Math.random() * b.length, e = Math.floor(e), rst += b.charAt(e);
	return rst
}

function enc(vstr, secret) {
	var key = CryptoJS.enc.Utf8.parse(secret),
		iv = CryptoJS.enc.Utf8.parse("0102030405060708"),
		str = CryptoJS.enc.Utf8.parse(vstr),
		cipher = CryptoJS.AES.encrypt(str, key, {
			iv: iv,
...
function asEnc(tx, keysec, serc, sec) {
	var rst = {},
		rd = genRandom(16);
	rst.encText = enc(tx, sec);
	rst.encText = enc(rst.encText, rd);
	rst.encSecKey = enc2(rd, keysec, serc);
	return rst;
}

function asDec(a, b, d, e) {
	var f = {};
	return f.encText = enc2(a + e, b, d), f
}
...
let key1 = "010001";
// bbZ(cnb.md)
let key2 = "";
// bbZ(["爱心", "女孩", "惊恐", "大笑"])
let key3 = "0CoJUm6Qyw8W8jud";
...
export class CloudMusic {
	...
	static getSecData(ids, csrf_token) {
		let query = {
		...
		let aesrst = asEnc(JSON.stringify(query), key1, key2, key3);

		let data = {
			params: aesrst.encText,
			encSecKey: aesrst.encSecKey
		};
		return data;
	}
	/**
	...
	*/
	static getURL(ids) {
		let csrf_token = CloudMusic.getToken();
		let api = "http://music.163.com/weapi/song/enhance/player/url";
		let data = CloudMusic.getSecData(ids, csrf_token);
